// Questions generated for Masterclass (Original End Term Questions)
const ENDTERM_ORIGINAL_QUESTIONS = [
  {
    "id": "et_q28",
    "module_id": "et_mod1",
    ...
    "correct": "Represent the query and retrieve semantically similar stored chunks",
    ...
    "tag": "Sir's Original Revision Question",
    "starred": false,
    "isStarred": false,
    "correct_idx": 0
  },
  {
    ...
    "correct": "Better preservation of boundary context with greater retrieval redundancy",
  ...
  },
  {
    ...
    "correct": "Re-chunk around more coherent boundaries and introduce suitable overlap",
  ...
  },
  {
    ...
    "correct": "The next action is selected using the current state and previous tool observations",
  ...
  },
  {
    ...
    "correct": "Allow read-only tools autonomously but require explicit approval before the irreversible action",
...
// Complete End Term Quiz Questions: Combining Sir's Original Revision Questions + 100 Sample End Term Questions
const ENDTERM_QUIZ_QUESTIONS = (() => {
  const sample100 = (typeof window !== "undefined" && window.ENDTERM_100_QUESTIONS)
    || (typeof ENDTERM_100_QUESTIONS !== "undefined" ? ENDTERM_100_QUESTIONS : []);
  
  const combined = [...ENDTERM_ORIGINAL_QUESTIONS];
  const seenIds = new Set(combined.map(q => q.id));
